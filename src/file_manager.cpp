...
std::vector<fs::directory_entry> FileManager::getItems() { return items; }

fs::path FileManager::getCurrentPath() { return currentPath; }

bool FileManager::isDirectory(int index) { return items[index].is_directory(); }
